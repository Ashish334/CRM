...
namespace CRM.Server.Web.Api.Security.Tokens
{
    public class TokenHandler : ITokenHandler
    {
        ...
        public AccessToken CreateAccessToken(ApplicationUser user, List<string> roles)
        {
            var refreshToken = BuildRefreshToken();
            var accessToken = BuildAccessToken(user, refreshToken, roles);
        ...
        private AccessToken BuildAccessToken(ApplicationUser user, RefreshToken refreshToken, List<string> roles)
        {
            ...
            return new AccessToken(accessToken , accessTokenExpiration.Ticks, refreshToken, roles);
        }
